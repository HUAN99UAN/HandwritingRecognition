...
\label{sss:method:segmentaton:splitimage}
	...
	\begin{figure}
		\centering
		\subfloat[]{
			\includegraphics[width=5em, height=3em, keepaspectratio=True]{shared/img/method/split_straight_path.png}%
			\raisebox{1em}{\hspace{2em} $\to$ \hspace{2em}}
			\includegraphics[width=5em, height=3em, keepaspectratio=True]{shared/img/method/split_straight_left.png}%
			\raisebox{1em}{\hspace{2em} $\&$ \hspace{2em}}
			\includegraphics[width=5em, height=3em, keepaspectratio=True]{shared/img/method/split_straigt_right.png}%
			\label{fig:method:segmentation:splitting:straight}%
		}
		
		\subfloat[]{
			\includegraphics[width=5em, height=3em, keepaspectratio=True]{shared/img/method/split_astar_path.png}%
			\raisebox{1em}{\hspace{2em} $\to$ \hspace{2em}}
			\includegraphics[width=5em, height=3em, keepaspectratio=True]{shared/img/method/split_astar_left.png}%
			\raisebox{1em}{\hspace{2em} $\&$ \hspace{2em}}
			\includegraphics[width=5em, height=3em, keepaspectratio=True]{shared/img/method/split_astar_right.png}%
