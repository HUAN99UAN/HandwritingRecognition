...
\author{Laura SOMETHING,
        Evangelos Karountzos% <-this % stops a space
...
% The paper headers
\markboth{Hand Writing Recognition Report June - 2016}%
...
\input{bare_jrnl_intro}
\input{bare_jrnl_prepro}
\input{bare_jrnl_charsegm}
\input{bare_jrnl_features}
\input{bare_jrnl_machlearn}
\input{bare_jrnl_results}
\input{bare_jrnl_disc}
\input{bare_jrnl_conclusion}
...
\bibitem{HWR:features1}
Hossain, M.Z., Amin, M.A. and Yan, H., 2012. Rapid feature extraction for optical character recognition. arXiv preprint arXiv:1206.0238.

\bibitem{HWR:features2}
